...
set psu_pll_init_data {
    ...
    mask_write 0XFD1A0028 0x8000FFFF 0x80005C29
		# : DDR_PLL INIT
    ...
    mask_write 0XFD1A0030 0xFE7FEDEF 0x7E6D6C6C
		# : UPDATE FB_DIV
    ...
    mask_write 0XFD1A002C 0x00717F00 0x00012A00
		# : BY PASS PLL
		# Register : DPLL_CTRL @ 0XFD1A002C</p>
    ...
    mask_write 0XFD1A003C 0xFE7FEDEF 0x7E4E2C62
		# : UPDATE FB_DIV
    ...
    mask_write 0XFD1A0038 0x00717F00 0x00013C00
		# : BY PASS PLL
		# Register : VPLL_CTRL @ 0XFD1A0038</p>
...
set psu_clock_init_data {
    ...
    mask_write 0XFF5E006C 0x013F3F07 0x01012002
    ...
    mask_write 0XFF5E0070 0x013F3F07 0x01010802
    ...
    mask_write 0XFF18030C 0x00020003 0x00000001
    ...
    mask_write 0XFF5E00B4 0x013F3F07 0x01010F00
...
set psu_mio_init_data {
    ...
    mask_write 0XFF180020 0x000000FE 0x00000020
    ...
    mask_write 0XFF180024 0x000000FE 0x00000020
    ...
    mask_write 0XFF180030 0x000000FE 0x00000004
    ...
    mask_write 0XFF18006C 0x000000FE 0x00000004
    ...
    mask_write 0XFF180078 0x000000FE 0x00000040
    ...
    mask_write 0XFF18007C 0x000000FE 0x00000040
    ...
    mask_write 0XFF180204 0xFFFFFFFF 0x08000200
    ...
    mask_write 0XFF180208 0xFFFFFFFF 0xFC00202A
    ...
    mask_write 0XFF180140 0x03FFFFFF 0x01BF1EDE
    ...
    mask_write 0XFF18014C 0x03FFFFFF 0x03FFFDFF
    ...
    mask_write 0XFF18015C 0x03FFFFFF 0x01F80ABF
    ...
    mask_write 0XFF180168 0x03FFFFFF 0x03F7F57D
    ...
    mask_write 0XFF180178 0x03FFFFFF 0x02FC0FC0
    ...
    mask_write 0XFF180184 0x03FFFFFF 0x0303F03F
		# : LOOPBACK
...
set psu_peripherals_init_data {
    ...
    mask_write 0XFF18031C 0x00007FFE 0x00000CD0
    ...
    mask_write 0XFF0A0244 0x03FFFFFF 0x00002000
		# : DIR MODE BANK 2
    ...
    mask_write 0XFF0A0248 0x03FFFFFF 0x00002000
    ...
    mask_write 0XFF0A0008 0xFFFFFFFF 0xDFFF2000
    ...
    mask_write 0XFF0A0008 0xFFFFFFFF 0xDFFF0000
		# : MASK_DATA_1_MSW HIGH BANK [51:42]
		# : MASK_DATA_1_LSW HIGH BANK [67:52]
		# : MASK_DATA_1_LSW HIGH BANK [77:68]
		# : ADD 5US DELAY
...
set psu_serdes_init_data {
    ...
    mask_write 0XFD40A368 0x000000FF 0x0000002E
    ...
    mask_write 0XFD40E368 0x000000FF 0x0000002E
    ...
    mask_write 0XFD40A370 0x000000FF 0x000000A1
    ...
    mask_write 0XFD40A374 0x000000FF 0x00000068
    ...
    mask_write 0XFD40E370 0x000000FF 0x000000A1
    ...
    mask_write 0XFD40E374 0x000000FF 0x00000068
...
set psu_resetout_init_data {
    ...
    mask_write 0XFD48001C 0x0000FFFF 0x0000E008
    ...
    mask_write 0XFD480200 0xFFFFFFFF 0x10EE7012
